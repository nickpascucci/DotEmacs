...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#05151E" :foreground "gray70" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 122 :width normal :foundry "unknown" :family "ProggySquareTTSZ"))))
 ...
 '(ediff-current-diff-A ((((class color) (min-colors 16)) (:background "#52006E" :foreground "white"))))
 '(ediff-even-diff-B ((((class color) (min-colors 16)) (:background "#004080" :foreground "White"))))
 '(error ((t (:foreground "Red" :weight bold))))
 '(flymake-errline ((((class color) (background dark)) (:background "#8F2B2B" :foreground "white"))))
 '(flymake-warnline ((((class color) (background dark)) (:background "gold" :foreground "black"))))
 ...
 '(font-lock-constant-face ((((class color) (min-colors 88) (background dark)) (:foreground "#3366CC"))))
 ...
 '(highlight-changes ((((min-colors 88) (class color)) (:background "seagreen" :foreground "gray90"))))
 ...
 '(org-todo ((t (:background "#042028" :foreground "#c64037" :weight bold))))
 ...
 '(variable-pitch ((t (:height 0.7 :family "Sans Serif"))))
