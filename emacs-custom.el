...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/docs/gtd/dev.org" "~/docs/gtd/hydro-project.org" "~/docs/gtd/privacy-project.org" "~/docs/gtd/reprap-project.org" "~/docs/gtd/life.org" "~/docs/gtd/gtd.org")))
